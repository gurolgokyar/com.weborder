...
public class WO_013_VAP_01 extends Hooks {
	...
	void testViewAllProductButton() {
		...
		for (int i = 0; i < namesOfProducts.size(); i++) {
			Assertions.assertEquals(expectedProductNames.get(i), namesOfProducts.get(i).getText(),
					"Expecting product" + " names do not match in the view all product home page");
		}
