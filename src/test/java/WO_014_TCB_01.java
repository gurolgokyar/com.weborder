...
public class WO_014_TCB_01 extends Hooks{
    ...
    void testThemeChangeButtonFunctionality() throws InterruptedException {
        ...
        String backgroundColorAfterThemeChangeButtonClicked =
                driver.findElement(By.xpath("//*[@id='root']/div")).getAttribute(
                "data-theme");

        Assertions.assertNotEquals(backgroundColor, backgroundColorAfterThemeChangeButtonClicked, "After clicked " +
                "theme change button, the color of page did not change");
    }
}
