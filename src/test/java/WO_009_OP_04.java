...
public class WO_009_OP_04 extends Hooks{
    ...
    void orderPlacementWithOutCartTypeTest(){
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//em[text() = 'Card " +
                "type cannot be empty']")));

        Assertions.assertEquals("Card type cannot be empty", driver.findElement(By.xpath("//em[text() = 'Card type cannot " +
                "be empty']")).getText(), "Expected alert message: \"Cart type can not be empty\" did not displayed");
    }
}
