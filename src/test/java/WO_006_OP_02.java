...
public class WO_006_OP_02 extends Hooks{
    ...
    void orderPlacementWithOutCalculationTest(){
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//em[text() = 'Fix errors in Product " +
                "Information ']")));

        Assertions.assertTrue(driver.findElement(By.xpath("//em[text() = 'Fix errors in Product Information ']")).isDisplayed(), "Expected error message did not displayed!");
